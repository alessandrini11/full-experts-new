...
<head>
    ...
    <title>Full Experts Consulting</title>
    <link rel="stylesheet" href="{{('style.css')}}">

    <!--=============== style demander Expertise ===================-->
    <link rel="stylesheet" href="{{('forms/demanderExpertise.css')}}">
...
<body>
    <header>
        ...
        <div class="heads2">
            ...
            <!--=============== popup Demande d'expertise  ===================-->
            <div id="popupConatain">
                <div id="myPopup" class="popup">
                    <div class="devenir__expert">
                        <div class="form-container">
                            <div class="steps-container" style="z-index: 7000;">
                                <div class="close-btn">
                                    <span>&times;</span>
                                </div>
                                <div class="hev">
                                    <h1>Formulaire de demande d'expertise</h1>
                                    <p>Besoin d'une expertise? Merci de remplir le formulaire ci-dessous</p>
                                </div>
                            </div>
                            <form action="{{url('/valid')}}" method="post" id="expertise-Form">
                                @csrf
                                <div class="step-content active" id="step1">
                                    ...
                                    <textarea name="message" id="message" required
                                        placeholder="Exprimez vos beoins*"></textarea>
                                </div>
            ...
            <div id="confirmationPopup" class="popup2" style="display:none;">
                <div class="popup-content">
                    <p>Merci de nous avoir sollicités. Nous prendrons attache avec vous dans les 48 prochaines heures
                    </p>
                    <button id="closeConfirmation">Fermer</button>
                </div>
            </div>
    ...
    <main>
        <section class="banner ">
            <div class="overlay">
                <div class="cass">
                    <h1 class="text-0">Full Experts Consulting</h1>
                    {{-- <h1 class="text_style typewriter-effect" id="typewriter-text">les Experts c’est nous!</h1> --}}
                    <p>Notre mission est de vous offrir de façon permanente un service
                        d’expertise compétitif,<br>
                        audacieux et adapté à vos besoins basés sur des investigations techniques de terrain.</p>
                    <h2 class="text_style typewriter-effect" id="typewriter-text"> <i>Les Experts c’est Nous!</i></h2>
                    ...
                    <a href="#" id="openFormBtn">
                        ...
                        <span></span>
                        <span></span>
                        <strong>Demande d'Expertise </strong>
                        <span class="arrow"><i class="fa-solid fa-greater-than"></i> <i
                                class="fa-solid fa-greater-than"></i> <i class="fa-solid fa-greater-than"></i></span>
                    </a>
                ...
                <div class="services">
                    ...
                    <div class="service-item show-animate">
                        <h2>Idées d'investissement</h2>
                        <p>Vous disposez de fonds et vous cherchez une idée
                            d’investissement rentable ?</p>
                    </div>

                    <div class="service-item show-animate">
                        <h2>Besoin de fonds</h2>
                        <p>Vous avez une idée d’investissement prometteuse mais
                            vous n’avez pas les fonds nécessaires
                            pour la concrétiser?</p>
                    </div>


                    <div class="service-item show-animate">
                        <h2>Objectif manqué</h2>
                        <p>Vous avez concrétisé votre projet d’investissement,
                            mais les résultats obtenus sont très
                            décevants ?</p>
                    </div>
                    <div class="service-item show-animate">
                        <h2>Viser plus haut</h2>
                        <p>Vous avez concrétisé votre idée de projet avec
                            succès, mais vous souhaitez maintenant
                            développer davantage votre activité ?</p>
                    </div>
        ...
        <section class="des-sec">
            <div class="desc">
                ...
                <div class="desc-1">
                    <h1 class="titl-des-1">Cabinet <br> d'Experts</h1>

                    <div class="des-p">
                        <p>
                            Au Cameroun, comme ailleurs, de nombreux projets d’investissement restent à l’état d’idées.
                            La méconnaissance de l’environnement économique,
                            souvent due à un manque de données fiables, entraîne la disparition prématurée de nombreux
                            projets. Pour réussir, il est essentiel de comprendre
                            les risques et d’adopter une approche stratégique.
                        </p>

                        <p>
                            FULL EXPERTS CONSULTING se positionne en tant que partenaire pour accompagner les porteurs
                            de projets. Notre approche couvre trois étapes clés :
                            <strong> la gestation d’idées, l’optimisation par l’excellence opérationnelle et le
                                développement des projets pour assurer leur succès.</strong>
                        </p>

                        <P>
                            Nous plaçons la collecte et l’analyse de données au cœur de notre démarche. Les
                            statistiques recueillies avant,
                            pendant et après chaque projet, sont essentielles pour prendre des décisions éclairées et
                            anticiper les risques.
                        </P>

                        <p>
                            Si vous vous reconnaissez dans l'une des catégories que nous avons identifiées, nous sommes
                            là pour vous accompagner,
                            que vous ayez besoin d’aide pour lancer une idée, optimiser un projet ou trouver des
            ...
            <div class="slider">
                <a href="{{url('/service')}}">
                    <div class="slide-track">
                        ...
                        <div class="slide">
                            <div>
                                <img src="{{ asset('images/b6.jpg') }}" alt="">
                                <p>Collecte & Analyse Des Données</p>
                            </div>
                        </div>
                        ...
                        <div class="slide">
                            <div>
                                ...
                                <p>Montage des Projets</p>
                            </div>
                        </div>

                        <div class="slide">
                            <div>
                                <img src="{{ asset('images/discussion.jpg') }}" alt="">
                                <p>Conseils & Accompagnement</p>
                            </div>
                        </div>
                        ...
                        <div class="slide">
                            <div>
                                ...
                                <p>Formation & Education</p>
                            </div>
                        </div>

                        <div class="slide">
                            <div>
                                <img src="{{ asset('images/marketing.jpg') }}" alt="">
                        ...
                        <div class="slide">
                            <div>
                                <img src="{{ asset('images/dev.jpg') }}" alt="">
                        ...
                        <div class="slide">
                            <div>
                                <img src="{{ asset('images/qhse.jpg') }}" alt="">
                                <p>Qualité Hygiène Sécurité Environnement (QHSE)</p>
                            </div>
                        </div>

                        <div class="slide">
                            <div>
                                <img src="{{ asset('images/gestion.jpg') }}" alt="">
                                <p>Gestion & Finances</p>
                            </div>
                        </div>

                        <div class="slide">
                            <div>
                                <img src="{{ asset('images/hotels.jpg') }}" alt="">
                                <p>Tourisme & Hôtellerie </p>
                            </div>
                        </div>
    ...
    <!--==================== expertises-conatiner ===================-->
    <section class="expertises-conatiner">
        <div class="expertises">
            <div>
                <hr>
                <h1>Des Experts à vos côtés</h1>
                <hr>
                <p>
                    Notre réseau professionnel compte plus de 50 collaborateurs et
                    experts issus de divers secteurs d’activités. Grâce à la présence
                    de nos équipes sur l’ensemble du territoire national, nous offrons
                    un maillage solide qui permet à notre cabinet d'être toujours au plus
                    près de ses partenaires, garantissant ainsi une réactivité et une proximité
                    optimale..</p>
            </div>
        </div>
    </section>
    ...
    <section class="values-container">
        ...
        <div class="values animate-on-scroll">
            <div class="value">
                <span><i class="fa-duotone fa-solid fa-star"></i></span>
                <h3>Excellence</h3>
                <p>Nous visons toujours l'excellence dans tout ce que nous entreprenons. Nos solutions sont conçues avec
                    un souci du détail et de la qualité garantissant des résultats exceptionnels à chacun de nos
                    clients. Nous croyons que seul un travail d'excellence peut mener à une véritable réussite.</p>
            </div>
            <div class="value">
                <span><i class="fa-sharp-duotone fa-solid fa-users"></i></span>
                <h3>Proximité</h3>
                <p>Être proche de nos clients est essentiel à notre approche. Nous privilégions une relation
                    personnalisée et attentive en restant à l'écoute de leurs besoins spécifiques. Cette proximité nous
                    permet de mieux comprendre leurs enjeux et de les accompagner efficacement tout au long de leur
                    projet.</p>
            </div>
            <div class="value">
                <span><i class="fa-solid fa-lightbulb"></i></span>
                <h3>Innovation </h3>
                <p>Nous mettons un point d'honneur à explorer constamment de nouvelles méthodes et solutions pour offrir
                    à nos clients des approches modernes et performantes. L'innovation est au cœur de notre métier, car
                    nous croyons que c'est en sortant des sentiers battus que nous pouvons apporter des résultats
                    durables.</p>
            </div>
            <div class="value">
                <span><i class="fa-regular fa-handshake"></i></span>
                <h3>Engagement</h3>
                <p>Nous nous engageons pleinement à chaque mission. Notre priorité est la réussite des projets que nous
                    accompagnons et cet engagement se traduit par une implication totale de nos équipes pour répondre
                    aux attentes de nos clients et aller au-delà de leurs espérances.</p>
            </div>
            <div class="value">
                <span><i class="fa-solid fa-people-group"></i></span>
                <h3>Précision</h3>
                <p>La performance est notre moteur principal. Nous avons toujours cherché à
                    repousser les limites et à atteindre l'excellence. En raison de notre
                    engagement à améliorer continuellement nos services, nous sommes en
                    mesure de nous ajuster rapidement aux évolutions du marché et de proposer
                    des solutions innovantes à nos clients.</p>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        ...
        <div class="video-list">
            <div class="vid">
                <video src="{{asset('videos/video1.mp4')}}" muted></video>
            </div>
            <div class="vid">
                <video src="{{asset('videos/video2.mp4')}}" muted></video>
            </div>
            <div class="vid">
                <img height="212px" src="{{asset('videos/photo1.jpeg')}}" alt="Image 1">
            </div>

            <div class="vid">
                <video src="{{asset('videos/video3.mp4')}}" muted></video>
            </div>
            <div class="vid">
                <img src="{{asset('videos/photo2.jpeg')}}" alt="Image 1">
            </div>
            <div class="vid">
                <video src="{{asset('videos/video4.mp4')}}" muted></video>
            </div>
             <div class="vid">
                <img src="{{asset('videos/photo3.jpeg')}}" alt="Image 1">
            </div>
