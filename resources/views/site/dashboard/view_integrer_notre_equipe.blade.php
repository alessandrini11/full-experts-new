            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        <h2>Liste de integrer notre equipe</h2>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$view->email}}</td>
                                <td>{{$view->phone}}</td>
                                <td>{{$view->expert_domain}}</td>
                                <td>

                                    <a href="{{url('/download-pdf', $view->cv)}}">Download</a>
                                </td>
                                <td>En attente</td>
                                <td>

                                    <a href="{{url('delete_equipe', $view->id)}}">
                ...
                <div class="recentCustumers" v-if="showFormUpdate">
                    ...
                    <form method="post" action="{{url('/approuve')}}">
                        ...
                        <div class="contains" hidden>
                            ...
                            <input type="text" value="Integrer notre equipe" name="type" class="form-control" hidden
                                id="role">
                        </div>
                        <div class="contains">
