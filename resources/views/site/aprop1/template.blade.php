...
<head>
    ...
    <!-- ================= Style.css =========================== -->
    <link rel="stylesheet" href="{{('aprop1/templete.css')}}">
...
<body>
    ...
    <section class="banner-global ">
        <div class="text-banner-global">
            <h1>Opter pour notre cabinet, c'est choisir l'excellence et la créativité.</h1>
        </div>
    </section>
    ...
    <div class="block">
        <div class="block-row">
            <div class="block1">
                <img src="{{ asset('images/methode.jpg') }}" alt="block-3-image">
            </div>
            <div class="block2">
                <div class="ln">
                    <h2 style="font-size: 4rem; margin-left: 0.5em; font-size: clamp(2em,5vw,4em); color: #2f3a4a;"> Méthodologie </h2>
                </div>
                <p style="font-size: clamp(.7rem, 2vw , 1.1rem);
                            text-align: justify;
                            color: #6c7b8a;">
                    Full Experts Consulting, de la collecte des données à la croissance de votre activité !
                    Afin d'aborder de manière efficace la situation actuelle de toute entreprise et de mettre en
                    place une stratégie appropriée, nous utilisons une approche en plusieurs étapes incluant : l'analyse
                    initiale, la collecte de données sur le terrain, la conception de stratégies, la création de
                    tableaux de bord personnalisés et l'évaluation continue des avancées avec les ajustements
                    nécessaires.
                    <br>

                    Nous nous efforçons de vous proposer de manière constante un service d'expertise compétitif,
                    audacieux et adapté à vos exigences en se basant sur des investigations techniques sur le
                    terrain.
                    <br> <br>
    ...
    <div class="block-ressources">
        <div class="block-ressource">
            <div class="block-ressource1">
                <img src="{{ asset('images/ressource.jpg') }}" alt="block-3-image">
            </div>
            <div class="block-ressource2">
                <div class="ln">
                    <h2 style="font-size: 4rem; margin-left: 0.5em; font-size: clamp(2em,5vw,4em); color: #2f3a4a;"> Ressources</h2>
                </div>
                <p style="font-size: clamp(.7rem, 2vw , 1.1rem);
                            text-align: justify;
                            color: #6c7b8a;">
                    Notre cabinet bénéficie d’un réseau dynamique et diversifié de plus de 250 collaborateurs
                    et experts, chacun apportant des compétences uniques et complémentaires. Ce vivier de
                    talents nous permet d’intervenir efficacement dans une multitude de domaines d’activités
                    allant de la finance à la technologie, en passant par le développement durable et le marketing. <br>
                    Nos équipes sont réparties sur l’ensemble du territoire national, ce qui constitue un atout majeur
                    pour notre entreprise. Grâce à ce maillage géographique, nous sommes en mesure d’établir des
                    relations solides et durables avec nos partenaires locaux. Cette proximité nous permet non seulement de mieux
                    comprendre les enjeux spécifiques de chaque région, mais aussi d’offrir des solutions sur mesure
                    qui répondent aux besoins particuliers de nos clients. <br> <br>
                    La diversité de notre équipe enrichit notre approche, favorisant l’innovation et la créativité.
                    Nous croyons fermement que la collaboration entre experts de différents horizons est la clé pour
                    relever les défis complexes d’aujourd’hui. Chaque membre de notre réseau joue un rôle essentiel
                    et nous veillons à créer un environnement où le partage des connaissances et des meilleures
                    pratiques est encouragé. <br>
                    En nous appuyant sur ce réseau solide, nous pouvons offrir un service de qualité, réactif et
                    adapté aux évolutions du marché. Notre engagement envers l’excellence et la satisfaction
                    client est renforcé par la richesse des compétences que nous réunissons. Ainsi, nous nous
                    positionnons comme un partenaire de choix pour accompagner nos clients vers la réussite.
    ...
    <div class="block-text">
        <p>Bien plus qu'un simple prestataire, un partenaire confiance pour votre croissance.</p>
    </div>


    <div class="block-choose">
        <!-- block 3     ------------------------------------------ -->
        <div class="block-choos">
            <div class="block-choos-block1">
                <img src="{{ asset('images/confiance.jpeg') }}" alt="block-3-image">
            </div>
            <div class="block-choos-block2">
                <div class="ln">
                    <h2 style="font-size: 4rem; margin-left: 0.5em; font-size: clamp(2em,5vw,4em); color: #2f3a4a;"> Pourquoi nous faire confiance ?</h2>
                </div>
                <p style="font-size: clamp(.7rem, 2vw , 1.1rem);
                            text-align: justify;
                            color: #6c7b8a;">
                    Nous avons mis en place une méthodologie de travail rigoureuse, efficace, basée sur la collecte des
                    données qui nous permet d’obtenir des insights précis, actuels et adaptés aux réalités et pratiques
                    du marché. Nos experts utilisent les données statistiques issues du terrain pour concevoir des
                    dispositifs sur mesure et formuler des recommandations pertinentes dans l’optique de la maximisation
                    des résultats. Nos processus confèrent à notre cabinet un positionnement de référence en matière
                    d’étude.
                    Full Experts Consulting dispose d'une expertise pointue dans des domaines spécifiques. Nos
                    consultants mettent leur expérience et outils à contribution pour mener à bien vos projets dans les
                    délais impartis. <br> <br>

                    Notre approche axée sur le client se manifeste par une totale transparence et une communication
                    régulière concernant l'avancement de votre dossier. Nous nous assurons que nos experts-consultants
                    soient en accord avec la culture de nos clients. Grâce à notre savoir-faire et à notre adaptabilité,
                    nous vous soutenons dans la création et la mise en place de stratégies novatrices, tout en vous
                    assurant l'intégrité et les résultats attendus. Grâce à notre approche collaborative, nous créons
                    ensemble des relations pérennes. <br> <br>
    ...
    <div class="block-text">
        <p>Full Experts Consulting utilise son savoir-faire pour favoriser le succès de ses partenaires.</p>
    </div>

    <div class="block-equipes">
        <div class="block-equipe">
            <div class="block-equipe-block1">
                <img src="{{ asset('images/ser9.jpeg') }}" alt="block-3-image">
            </div>
            <div class="block-equipe-block2">
                <div class="ln">
                    <h2 style="font-size: 4rem; margin-left: 0.5em; font-size: clamp(2em,5vw,4em); color: #2f3a4a;">Notre Équipe d'Experts</h2>
                </div>
                <p style="font-size: clamp(.7rem, 2vw , 1.1rem) ; text-align: justify; color: #6c7b8a;">
                    Nos experts sont les véritables moteurs de votre réussite
                    apportant des compétences variées et complémentaires pour répondre à vos besoins spécifiques.
                    Fort d’une expérience solide dans des domaines tels que la collecte et l’analyse des données,
                    le montage des projets développement web, le marketing, la gestion financière, la qualité l'hygiène
                    la sécurité et l'environnement (QHSE), ainsi que les services d’hôtellerie et tourisme, notre équipe
                    est dédiée à fournir des solutions de qualité. Chacun de nos spécialistes maîtrise les tendances
                    et les meilleures pratiques de son secteur garantissant ainsi une approche pertinente et efficace.
                    <br><br>
                    Loin de se limiter à des services techniques, nos experts adoptent une approche personnalisée en prenant
                    le temps d'analyser vos besoins uniques et en élaborant des solutions sur mesure. Grâce à une communication
                    transparente et un véritable partenariat, ils travaillent en étroite collaboration avec vous, s'assurant
                    que chaque aspect de votre projet est pris en compte. Ils apportent une valeur ajoutée significative par
                    leur capacité à anticiper les besoins, optimiser les ressources, et intégrer des innovations qui renforceront
                    votre compétitivité.
                    <br><br>
                    L'intégrité est au cœur de notre mission. Nos experts agissent avec honnêteté et transparence,
                    garantissant que les informations et recommandations fournies reposent sur des données fiables
                    et des pratiques éthiques. Ils comprennent l'importance de la confiance dans la relation client
                    et s'engagent à la maintenir à chaque étape. En plus de leur expertise technique, nos experts
                    sont des collaborateurs engagés, prêts à travailler ensemble pour atteindre les objectifs fixés.
                    Ils partagent leurs connaissances et compétences avec le reste de l'équipe, favorisant un environnement
                    d'apprentissage continu et d'amélioration collective.
                    <br><br>
                    En choisissant de travailler avec nos experts, vous optez pour un accompagnement de qualité,
                    axé sur la performance et l'innovation. Leur engagement à vos côtés et leur désir de voir votre
                    entreprise prospérer font d'eux des partenaires indispensables pour réaliser vos ambitions.
                </p>
            </div>
        </div>
    </div>
    ...
    <script src="{{('aprop1/templete.js')}}"></script>
