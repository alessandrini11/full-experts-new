...
<body>
    ...
    <section class="banner-global ">
        <div class="text-banner-global">
            ...
            <p>Vous souhaitez échanger avec un expert ?</p>
        ...
        <div class="row ">
            ...
            <div class="mb-4 col-md-4">
                <p style="text-align: justify;">
                    Chaque mandant fait face à une situation particulière et a des besoins uniques. C’est pourquoi nous
                    sommes à votre écoute pour comprendre vos enjeux et besoins afin de pouvoir.
                </p>
            ...
            <div class="mb-4 col-md-4">
                <p style="text-align: justify;">
                    Vous conseiller et vous proposer le(s) service(s) qui conviendront à votre situation. Bénéficiez dès
                    maintenant du conseil gratuit d’un expert en nous contactant par mail ou par téléphone.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid c2">
        <div class="row r1" style="padding: 0; border-bottom: 1px solid #302F83; border-top: 1px solid #302F83;">
            <!--part 1-->
            <div class="mt-5 mb-3 contactdiv col-md-5 col-12" style="color: rgb(14, 13, 13);">
                <div class="image-container">
                    <img src="./images/conseiller.jpg" alt="Conseiller" class="img-fluid">
                </div>
            </div>
            <!--part 2-->
            <div class="mt-5 mb-3 contactdiv col-md-6 col-12" style="color: rgb(24, 24, 24);">
                <form action="{{url('/contacts_valid')}}" method="post" id="contactform">
                    @csrf
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        <input type="number" name="phone" placeholder="Entrer votre numero de telephone" required>
                        <input type="text" name="message" list="browsers" id="browser" placeholder="conseil" required>
                    </div>
                    <textarea class="mt-4" name="more_message" id="textareas" placeholder="Nous en dire plus (optionnel)..." cols="40"></textarea>
                    <button type="submit" id="envoyer" name="envoyer">Envoyer <i class="fa-solid fa-arrow-right"></i></button>
                </form>
            </div>
        </div>
    </div>
